...
app.get("/big-question", (req, res) => {
    const bigQuestion = "Du kender det... Følelsen i kroppen. Du har netop set det, de flotte lys, den store bro, de smukke mennesker. Hun har en rød kjole på, han er velfriseret, de hvide tænder, var der ikke også en opknappet skjorte? De hungrende øjne, den stikkes dybt ned. Gaflen i pizzaen. Det er Dr. Oetker. Du er sulten. Men hvad er klokken? Ikke spisetid. Den er ikke 18. Kan man rejse i tid? Tid er et flydende begreb. Tid er relativt til hvor man er. Kant ville sige, det er en anskuelsesform, vi erkender Verden igennem - sammen med rum. Tid og rum udgør sammen et grundmodus for vores opfattelse af det alt. Man siger, at tro kan flytte bjerge, og du er sulten. Hvor skal du være inden for Rigsfællesskabets grænser for at der er kortest tid til din ønskede middag? Måske har du spist din aftensmad blot for et par timer siden og gerne vil ride på en ny bølge, der glider ind over målstregen, når de to visere flugter med hinanden, hvor den store viser peger mod himlen og den lille mod klikgulvet. Den lige linje. Livets store spørgsmål, ja. Lad os dykke ned i det...."
